...
5. [while](#while)
6. [function](#function)
7. [input alma](#input-alma)
8. [Python dosyası terminalden nasıl çalıştırılır](#python-dosyası-terminalden-nasıl-çalıştırılır)
...
- yazdigim functions.py dosyasindan ornek vermek gerekirse:
...
**Örnek terminal çıktısı** (`python3 calculator.py`):
...
## Python dosyası terminalden nasıl çalıştırılır
